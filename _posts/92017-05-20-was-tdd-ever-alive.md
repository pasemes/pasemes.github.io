...
Confidence: TDD is one way to programmers feel confident that their code works.  However, developers should mix up the concepts of TDD and self-testing code. One of the benefits of TDD include producing self-testing code.
