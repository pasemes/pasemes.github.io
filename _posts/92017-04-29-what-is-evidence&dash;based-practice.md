...
The notion of EBP dates from the beginning of the 1990s in the Medicine discipline. In 1990 Dr. Gordon Guyatt introduced a new concept called "Scientific Medicine" to describe a new method of teaching medicine at the bedside, using the crictical appraisal techniques from Dr. David Sackett. One year later the term "Evidence-Based Medicine" was coined in the ACP Journal Club Editorial. Since them the 
